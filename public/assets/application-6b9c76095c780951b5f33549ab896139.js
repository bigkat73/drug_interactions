...
(function() {
  App.controller('MedicationsCtrl', [
    '$scope', 'Medication', 'Interaction', function($scope, Medication, Interaction) {
      $scope.selected_medications = [];
      $scope.selected_ids = [];
      $scope.interaction_text = "Choose meds";
      $scope.medications = Medication.query();
      return $scope.addMedication = function(med) {
        var response;
        $scope.selected_medications.push(med);
        $scope.selected_ids.push(med.id);
        response = Interaction.get({
          medication_ids: $scope.selected_ids.toString()
        });
        return $scope.interaction_text = response;
      };
    }
  ]);
...
(function() {
  App.factory('Interaction', [
    '$resource', function($resource) {
      return $resource('/interactions.json?medication_ids=:medication_ids', {
...
(function() {
  App.factory('Medication', [
    '$resource', function($resource) {
      return $resource('/medications/:id', {
        id: '@id'
      });
    }
  ]);
